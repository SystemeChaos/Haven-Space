export enum AlterRole {
  ...
  ARCHITECT = 'Architect',
  RELAY_ALTER = 'Relay Alter',
  ERASER = 'Eraser',
  ANCHOR = 'Anchor',
  FUNCTIONAL_FRAGMENT = 'Functional Fragment',
}
...
export enum Disorder {
  ...
  DYSORTHOGRAPHIA = 'DYSORTHOGRAPHIA',
...
export const ROLE_CONFIGS: Record<AlterRole, RoleConfig> = {
  ...
  [AlterRole.PAIN_HOLDER]: { color: '#B91C1C', description: 'Absorbe et stocke les douleurs physiques, somatiques ou chocs corporels liés aux traumatismes' },
  [AlterRole.ANESTHETIC]: { color: '#38BDF8', description: 'Bloque les sensations physiques ou les émotions intenses lors d\'un choc ou d\'un déclencheur soudain' },
  [AlterRole.PROFESSIONAL]: { color: '#334155', description: 'Gère les tâches professionnelles, scolaires ou administratives en se détachant des émotions' },
  [AlterRole.FRONT_RUNNER]: { color: '#65A30D', description: 'Gère la vie quotidienne à l\'avant (au front) de manière régulière sans être l\'Hôte principal' },
  [AlterRole.INFANT]: { color: '#FDE68A', description: 'Alter pré-verbal qui exprime les besoins primaires ou les traumatismes précoces sans utiliser les mots' },
  [AlterRole.ELDER]: { color: '#92400E', description: 'Apporte de la sagesse, du recul et une vision philosophique sur le fonctionnement interne du système' },
  [AlterRole.MESSENGER]: { color: '#0EA5E9', description: 'Transmet les informations et fait le lien entre des alters qui ne peuvent pas communiquer directement' },
  [AlterRole.TRANSLATOR]: { color: '#7C3AED', description: 'Traduit les pensées, les images ou le langage métaphorique de certains alters pour le rendre compréhensible au reste du système' },
  [AlterRole.SECRET_KEEPER]: { color: '#1F2937', description: 'Conserve et protège une information, un tabou ou un souvenir spécifique pour éviter qu\'il ne se propage dans le système' },
  [AlterRole.ARCHITECT]: { color: '#0D9488', description: 'Crée, modifie et entretient les paysages, les pièces ou les structures du monde interne' },
  [AlterRole.RELAY_ALTER]: { color: '#CA8A04', description: 'Sert de point d\'ancrage ou de zone de passage obligatoire lors d\'un switch difficile entre deux alters qui ne se supportent pas' },
  [AlterRole.ERASER]: { color: '#64748B', description: 'Intervient juste après une crise ou un switch chaotique pour effacer les traces de panique et redonner une apparence de normalité à l\'extérieur' },
  [AlterRole.ANCHOR]: { color: '#0F766E', description: 'Maintient le corps connecté à la réalité présente et à l\'environnement physique pour empêcher une dissociation totale' },
  [AlterRole.FUNCTIONAL_FRAGMENT]: { color: '#A3A3A3', description: 'Alter très limité qui n\'existe que pour accomplir une seule action ultra spécifique avant de se rendormir' },
};
